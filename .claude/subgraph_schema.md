...
## This is the subgraph schema  for TheGraph  



type Protocol implements IHasLoans @entity(immutable: false) {
  id: ID!
...
type ProtocolCollateral @entity(immutable: false) {
  id: ID!
  collateralToken: Token
  tokenVolumesByLendingToken: [TokenVolume!]! @derivedFrom(field: "_protocolCollateral")
}

type MarketPlace implements IHasLoans @entity(immutable: false) {
  id: ID!
...
type BidCollateral @entity(immutable: false) {
  id: ID!
  amount: BigInt!
  tokenId: BigInt
  type: String
...
type FundedTx @entity(immutable: false) {
  id: ID!
  bid: Bid!
  timestamp: BigInt!
}
...
type Lender implements IHasLoans @entity(immutable: false) {
  id: ID!
  marketplaceId: BigInt!
  lenderAddress: Bytes!
  firstInteractionDate: BigInt!
...
type Borrower implements IHasLoans @entity(immutable: false) {
  id: ID!
  marketplaceId: BigInt!
  borrowerAddress: Bytes!
  firstInteractionDate: BigInt!
...
type TokenVolume implements IDurationAverage @entity(immutable: false) {
  id: ID!
...
type MarketCommitmentStdDev @entity(immutable: false) {
  id: ID!
...
type CommitmentZScore @entity(immutable: false) {
  id: ID!
  commitment: Commitment!
  zScore: BigDecimal!
}
...
type CommitmentReward @entity(immutable: false) {
  id: ID!
  createdAt: BigInt!
  updatedAt: BigInt!
...
type RewardAllocation @entity(immutable: false) {
  id: ID!
  createdAt: BigInt!
  updatedAt: BigInt!
...
type BidReward @entity(immutable: false) {
  id: ID!
  createdAt: BigInt!
  updatedAt: BigInt!
